...
class _GuideRequest extends State<GuideRequest> {
  ...
  Widget _pendingView(BuildContext context, TripRepository model) {
    return FutureBuilder(
      future: model.fetchPending(),
  ...
  Widget _approvedView(BuildContext context, TripRepository model) {
    return FutureBuilder(
      future: model.fetchApproved(),
      builder: (BuildContext context, AsyncSnapshot snaps) {
        //  print(model.notices);
            ...
            body: TabBarView(
              children: [
                Container(
                    ...
                    child: _pendingView(context, TripRepository())),
                Container(
                    height: MediaQuery.of(context).size.height,
                    child: _approvedView(context, TripRepository()))
              ],
            )));
  }
}
