...
import 'package:ghumnajaam/inputs/form_inputs/location.dart';
...
class _GuideSignUpPage extends State<GuideSignUpPage>
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  new Container(
                    ...
                    padding: const EdgeInsets.only(left: 0.0, right: 10.0),
                    child: LocationInput(_setLocation),
                  ),
                  SizedBox(
                    height: 24.0,
                  ),
  ...
  void _setLocation(LocationData locData) {
    ...
    _lattitudeController.text = locData.latitude.toString();
  ...
  _onSignUpButtonPressed() {
    ...
    _loginBloc.add(SignUpButtonPressed(
        ...
        lattitude: double.parse(_lattitudeController.text),
